...
namespace RoboRemote.Classes
{
    public static class StaticUtils
    {
        public static class Regex
        {
            ...
            public static bool CheckIsTrue(string str)
            {
                System.Text.RegularExpressions.Regex regex = new System.Text.RegularExpressions.Regex(@"^(?i)true$|^(?i)t$|^1$");
                return regex.IsMatch(str);
            }
            public static bool CheckIsFalse(string str)
            {
                System.Text.RegularExpressions.Regex regex = new System.Text.RegularExpressions.Regex(@"^(?i)false$|^(?i)f$|^0$|^-1$");
                return regex.IsMatch(str);
            }
        }
